...
export const results: EvalResult[] = [
 {id:'er1',testCaseId:'tc1',promptVersionId:'pv1',modelId:'qwen',modelName:'Qwen',modality:'text',modelOutput:'姓名：李建国\n出生：1948年，苏州\n家庭：父亲为木匠，母亲照顾五个孩子\n教育：8岁就读平江路小学，喜爱语文。',latencyMs:1280,score:92,dimensionScores:{accuracy:95,completeness:90,format:94,usefulness:91,safety:100},badCaseType:'无',judgeComment:'关键事实提取完整，结构清晰。',suggestion:'可将家庭成员数量表述得更严谨。',createdAt:'2026-07-10T08:20:00.000Z'},
 {id:'er2',testCaseId:'tc3',promptVersionId:'pv1',modelId:'deepseek',modelName:'DeepSeek',modality:'text',modelOutput:'1960年，十五岁的我第一次离开家乡；八年后，我顺利高中毕业。',latencyMs:1640,score:58,dimensionScores:{accuracy:42,completeness:55,format:85,usefulness:48,safety:80},badCaseType:'事实错误',judgeComment:'未识别年龄与出生年份的明显冲突，直接延续了错误叙事。',suggestion:'增加时间线一致性检查，遇到冲突时暂停生成并向用户澄清。',createdAt:'2026-07-11T13:45:00.000Z'}
]
